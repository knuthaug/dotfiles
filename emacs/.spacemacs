...
values."
  (setq-default
   ...
   '(
     ...
     ;; ----------------------------------------------------------------
     helm
     (osx :variables osx-option-as 'alt)
     ruby
     auto-completion
     ;; better-defaults
     emacs-lisp
